...
for i = 2:nn1.n
    ...
    for j = 1:10
        for k = j:10
            ...
            correlations_before(i,j,k) = mean(rel_corrs(:),"omitnan");
            correlations_before(i,k,j) = mean(rel_corrs(:),"omitnan");
            correlations_after(i,j,k) = mean(Srel_corrs(:),"omitnan");
            correlations_after(i,k,j) = mean(Srel_corrs(:),"omitnan");
        end
    end
end
