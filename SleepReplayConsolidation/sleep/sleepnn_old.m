...
for t=1:numiterations
        ...
        rescale_fac = 1/(dt*opts.max_rate);         % scale with the maximum of the avtivation
        ...
        for l = 2 : numel(nn.size)
            ...
            % STDP  - update the weights with the sort of Hebbian rule
            ...
            nn.layers{l}.sum_spikes = nn.layers{l}.sum_spikes + nn.layers{l}.spikes;      % running sum      
